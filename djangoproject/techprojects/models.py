...
class ProjectRegistration(models.Model):
    ...
    repo_details = models.JSONField(
        null=True, blank=True
    )  # response from github api containing additional details about the repository like number of stars, forks, etc.
...
class ProjectResourceLink(
    models.Model
):  # additional links to resources like documentation, demo, etc.
    project = models.ForeignKey(
        ProjectRegistration, on_delete=models.CASCADE, related_name="resource_links"
    )
