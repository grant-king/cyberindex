<template>
    <div class="bg-black/50 pb-16 pt-24 sm:pb-24 sm:pt-32 xl:pb-32">
        <div class="bg-transparent pb-20 sm:pb-24 xl:pb-0">
            <div
                ...
                <div class="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
                    <div class="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
                        <img class="absolute inset-0 size-full rounded-2xl bg-transparent object-cover shadow-2xl"
                            :src="sponsor_avatar"
                            alt="" />
                    </div>
                </div>
                <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                    <figure class="relative isolate pt-6 sm:pt-12">
                        ...
                        <figcaption class="mt-8 flex gap-x-6 text-base items-center">
                            <div>
