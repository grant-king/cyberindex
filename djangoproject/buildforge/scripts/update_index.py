...
vue_index_file = '../static/buildforge/index.html'
django_index_file = '../templates/buildforge/index.html'
...
def extract_file_names(file_path):
    ...
    with open(file_path, 'r') as file:
        ...
        js_match = re.search(r'/static/buildforge/assets/index-(.+?)\.js', content)
        css_match = re.search(r'/static/buildforge/assets/index-(.+?)\.css', content)
